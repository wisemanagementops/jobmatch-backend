...
CRITICAL RULES - WORK EXPERIENCE:
- Each work experience entry (different role/company) MUST remain as its own SEPARATE and DISTINCT section
- NEVER merge, combine, or consolidate multiple work experiences into one
- Each job MUST keep its own job title, company name, dates, and bullet points
- If the original resume has 3 jobs, the tailored resume MUST also have exactly 3 separate jobs
- Preserve the exact number of work experience entries from the original resume
