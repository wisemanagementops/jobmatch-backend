...
// CORS configuration - UPDATED TO FIX CORS ERRORS
const corsOptions = {
  origin: function (origin, callback) {
    ...
    // Production frontend URLs - allow all jobmatch vercel.app domains
    if (origin.includes('jobmatch') && origin.includes('vercel.app')) {
